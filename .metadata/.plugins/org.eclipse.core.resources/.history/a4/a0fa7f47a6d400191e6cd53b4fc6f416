...
public class Order
{
	 ...
	 *
	 * @param customer - customer who created the order 
	 ...
	 */
	public Order(Customer customer, String billName, String billAddr1, String billAddr2,
			...
			String cardHolder, int shippingMethod, Collection<OrderItem> items)
	{
		...
		/*
		 ...
		 com.ibm.websphere.samples.pbw.ejb.IdGeneratorHome.class);
		 
		 try
		 {        
		 IdGenerator idGenerator= idGeneratorHome.findByPrimaryKeyUpdate("ORDER");
